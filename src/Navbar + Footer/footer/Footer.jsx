...
const Footer = () => {
  return (
    <div class="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4 ">
      <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4 ">
        <div class="flex flex-col flex-shrink-0">
          ...
          <div className="flex items-center gap-x-4 mt-12">
            ...
            <button
              aria-label="youtube"
              class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white w-10 h-10 flex-shrink-0 bg-purple-600 cursor-pointer  rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors duration-300 ease-in-out"
            >
              <svg
                width="18"
                height="13"
        ...
        <div class="flex flex-col">
          <h2 class="text-base font-semibold leading-4 text-gray-800 dark:text-black">
            Support
          </h2>
          <a
            href="javascript:void(0)"
            class="focus:outline-none focus:underline hover:text-gray-500 text-base leading-4 mt-6 text-gray-800 dark:text-black cursor-pointer"
          >
            Legal policy
          </a>
          <a
        ...
        <div className="mt-10 lg:block hidden">
          <label class="text-xl font-medium leading-5 text-gray-800 dark:text-black">
            Get updates
          </label>
